namespace CogentCode.Template.Presentation.Api.Controllers.V1
{
    using Asp.Versioning;
    using CogentCode.Template.Application.Categories;
    using CogentCode.Template.Domain;
    using CogentCode.Template.Presentation.Api.Internal;
    using CogentCode.Template.Presentation.Api.Internal.Constants;
    using MediatR;
